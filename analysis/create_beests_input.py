...
def main():
  ...
  # Baseline or folow up?
  visit = 'BL'

  # Location of the csv files to be read:
  data_dir = '/home/dan/projects/imagen/data/protected/recieved/SST/SST_' + visit + '_behavioraldata'

  # Location of by-subject output:
  dump_dir = '/home/dan/projects/imagen/data/task_sst/by-subject-' + visit + '/'
  ...
  # Only care to output one file of misc data:
  print('Saving misc_sst_data_' + visit + '.csv')
  misc.to_csv('misc_sst_data_' + visit + '.csv', index=False)
